...
/**
 * _merger - sorts and merges the sub arrays in source
...
void _merger(size_t start, size_t middle, size_t end, int *dest, int *source)
{
size_t i, j, k;
...
/**
 * _spliter - recursively splits the array and merges the sorted arrays
...
void _spliter(size_t start, size_t end, int *array, int *copy)
{
size_t middle;
...
return;
middle = (start + end) / 2;
_spliter(start, middle, array, copy);
_spliter(middle, end, array, copy);
_merger(start, middle, end, array, copy);
